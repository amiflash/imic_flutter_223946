  ...
  void doSaveUserInfo() {
    FileManager.instance
        ...
        print('new avatar file: ${value.path},');
          String avatarURL = value.uri.pathSegments.last;
          APIService().updateUser(userName, _user.email, avatarURL)
          .then((json) {
              _userProvider.updateUserNameAndAvatarURL(json, _user.id)!;
